  ...
  Widget build(BuildContext context) {
    return SafeArea(
      child: FlutterCarouselIntro(
        ...
        skipLabel: const Text('Skip', style: TextStyle(color: Colors.black)),
        nextLabel: const Text('Next', style: TextStyle(color: Colors.black)),
        doneLabel: const Text('Done', style: TextStyle(color: Colors.black)),
